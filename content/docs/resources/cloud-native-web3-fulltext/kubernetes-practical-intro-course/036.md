...
<p><img loading="lazy" src="/pictures/study-disign/3755760d9fcbe39cb059.webp" alt="图片"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/bd88f12cd7e934fd44f3.webp" alt="图片"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/d71721bd8459076c4b16.webp" alt="图片"></p>

<p>因为docker-compose在底层还是调用的Docker，所以它启动的容器用 docker ps 也能够看到：</p>

<p><img loading="lazy" src="/pictures/study-disign/1e9f6071220211045f77.webp" alt="图片"></p>

<p>不过，我们用 docker-compose ps 能够看到更多的信息：</p>

<p><img loading="lazy" src="/pictures/study-disign/7eab7838e19cb546f540.webp" alt="图片"></p>

<p>下面我们把Nginx的镜像改个标签，上传到私有仓库里测试一下：</p>

<p>再用curl查看一下它的标签列表，就可以看到确实上传成功了：</p>

<p><img loading="lazy" src="/pictures/study-disign/4ce4ac046a157b38fe15.webp" alt="图片"></p>

<p>想要停止应用，我们需要使用 docker-compose down 命令：</p>

<p><img loading="lazy" src="/pictures/study-disign/55714cc6af580572800a.webp" alt="图片"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/0c7a5bb814c41333a23c.webp" alt="图片"></p>

<p>我们也可以用 docker-compose exec 来进入容器内部，验证一下这几个容器的网络标识是否工作正常：</p>

<p><img loading="lazy" src="/pictures/study-disign/6e18a1717a87aad0997f.webp" alt="图片"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/ad4fec3743bbd8a6dc81.webp" alt="图片"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/d0ae71bcbbc11e86d069.webp" alt="图片"></p>
