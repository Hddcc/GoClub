---
title: "05 解决 K8s 落地难题的方法论提炼"
weight: 6
type: docs
bookToC: true
---

<div class="goclub-source-note">来源：<a href="https://study.disign.me/document/Kubernetes%20%e5%ae%9e%e8%b7%b5%e5%85%a5%e9%97%a8%e6%8c%87%e5%8d%97/05%20%e8%a7%a3%e5%86%b3%20K8s%20%e8%90%bd%e5%9c%b0%e9%9a%be%e9%a2%98%e7%9a%84%e6%96%b9%e6%b3%95%e8%ae%ba%e6%8f%90%e7%82%bc.md" target="_blank" rel="noopener noreferrer">技术书栈原文</a>。本页按授权迁移至 GoClub。</div>

<h1 id="05-解决-k8s-落地难题的方法论提炼">05 解决 K8s 落地难题的方法论提炼</h1>
...
<p><img loading="lazy" src="/pictures/study-disign/e067cf2e5847e56645dc.webp" alt="5-1-jenkinsx_arch"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/1b2b1f62d6319b6a21a8.webp" alt="5-1-kiosk-workflow"></p>
...
<p><img loading="lazy" src="/pictures/study-disign/6a3b73e3fa9ab23d3d88.webp" alt="5-1-security-attach-interface"></p>
...
<p>本攻击面需要防范的地方是防止攻击者能直接在容器内部执行程序的能力。比如 Kubernetes 的 kubectl exec 命令就可以进入容器内部执行命令。另外，攻击者如果包含有运行容器的权限，就可以使用合法的 Service Account 账号访问 API Server，然后尝试攻击。还有如果容器内置了 SSH 服务，也能通过网络钓鱼的方式让攻击者获取容器的远程访问权限。</p>
...
<p>这个技术主要是攻击者通过清空日志或者事件来隐藏自己的攻击行踪的技术。比如：攻击者通过删除容器系统日志来隐藏后门程序容器的破坏行为。另外攻击者可以通过 kubectl delete 方式重置容器实例，变相清空事件日志来达到隐藏攻击行为。</p>
